...
A professional LinkedIn communications assistant who reads your messages, understands context, drafts smart replies, and only sends after you give the green light.

## Configuration

- **Mode:** skills
- **Agent ID:** `aa5196cd-321a-4bd7-ac90-3a8dae911539`
...
<script
  ...
  data-agent-id="aa5196cd-321a-4bd7-ac90-3a8dae911539"
  data-api-key="a2a_your_key_here"
  data-title="LinkedIn Inbox Assistant"
></script>
```
